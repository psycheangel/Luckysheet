...
function createFilterOptions(luckysheet_filter_save, filterObj) {
  ...
  let newSelectedHTML =
    ...
    Store.currentSheetIndex +
    '" class="luckysheet-cell-selected luckysheet-filter-selected ' +
    uuidInline +
    ' inline"></div>';
  ...
  for (let c = c1; c <= c2; c++) {
    ...
    if (filterObj == null || filterObj[c - c1] == null) {
      const uuidInline = getComputedInlineClassStyling(`
      &.inline {
    left:${Store.visibledatacolumn[c] - 20}px;
    top:${row_pre}px;
    display:${isHide ? "none" : "block"};
      ...
      optionHTML +=
        ...
        uuidInline +
        ' inline"><i class="fa fa-caret-down" aria-hidden="true"></i></div>';
    } else {
      let caljs_data;
    ...
    display:${isHide ? "none" : "block"};
      ...
      optionHTML +=
        ...
        '" data-edc="' +
        c2 +
        '" class="luckysheet-filter-options luckysheet-filter-options-active ' +
        uuidInline +
        ' inline"><i class="fa fa-filter luckysheet-mousedown-cancel" aria-hidden="true"></i></div>';
    }
  }
...
function initialFilterHandler() {
  ...
  $(".luckysheet-cols-menu .luckysheet-cols-submenu").hover(
   ...
   top: ${top}px;
    left: ${left}px;
      ...
      `);
      $attr.addClass(uuidInline + " inline").show();
      rightclickmenu = $t;
    },
    function () {
      let $t = $(this),
  ...
  $("#luckysheet-filter-selected").click(function () {
    ...
    height: ${mheight}px;
      ...
      `);
    $menu.addClass(uuidInline + " inline").show();
    clearTimeout(hidefilersubmenu);
  });
    ...
    function () {
      ...
      if (JSON.stringify(bgMap).length > 2 && Object.keys(bgMap).length > 1) {
          ...
          if (bgMap[b] == 0) {
            const uuidInline = getComputedInlineClassStyling(`
             ...
             background-color: ${b};
              ...
              `);
            bgColorItemHtml +=
              '<div class="item luckysheet-mousedown-cancel"><label class="luckysheet-mousedown-cancel ' +
              uuidInline +
              ' inline" title="' +
              b +
        ...
        filterBgColorHtml =
          ...
          '</div><div class="luckysheet-mousedown-cancel ' +
          uuidInline +
          ' inlineHeight">' +
          bgColorItemHtml +
          "</div></div>";
      ...
      if (filterBgColorHtml == "" && filterFcColorHtml == "") {
        ...
        content =
          filterBgColorHtml +
          filterFcColorHtml +
          '<div class="luckysheet-mousedown-cancel"><button id="luckysheet-filter-orderby-color-confirm" class="btn btn-primary luckysheet-mousedown-cancel ' +
          uuidInline +
          ' inline" >' +
