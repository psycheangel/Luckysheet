...
const conditionformat = {
  ...
  textCellColorHtml: function () {
    ...
    return `<div id="textCellColor">
                    <div class="colorbox">
                        ...
                        <input id="textcolorshow" data-tips="${conditionformat_Text.textColor}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="#9c0006" class="display-none ${uuid}">
                    </div>
                    <div class="colorbox">
                        <input id="checkCellColor" type="checkbox" checked="checked">
                        <label for="checkCellColor">${conditionformat_Text.cellColor}：</label>
                        <input id="cellcolorshow" data-tips="${conditionformat_Text.cellColor}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="#ffc7ce" class="display-none ${uuid}">
                    </div>
                </div>`;
  },
  selectRange: [],
  ...
  CFiconsDialog: function () {
    ...
    let content = `<div class="box">
                            <div id="${uuid}" class="boxBottom">${conditionformat_Text.pleaseSelectIcon}</div>
                            <div class="title">${conditionformat_Text.direction}</div>
                            <div class="list">
                                <div class="left">
                                    <div class="item" data-len="3" data-leftMin="0" data-top="0" title="${conditionformat_Text.threeWayArrow}(${conditionformat_Text.multicolor})"><div  id="${uuid}" class="positionBoxLeftOne"></div></div>
                                    <div class="item" data-len="3" data-leftMin="0" data-top="1" title="${conditionformat_Text.threeTriangles}"><div  id="${uuid}" class="positionBoxLeftTwo"></div></div>
                                    <div class="item" data-len="4" data-leftMin="0" data-top="2" title="${conditionformat_Text.fourWayArrow}(${conditionformat_Text.multicolor})"><div  id="${uuid}" class="positionBoxLeftThree"></div></div>
                                    <div class="item" data-len="5" data-leftMin="0" data-top="3" title="${conditionformat_Text.fiveWayArrow}(${conditionformat_Text.multicolor})"><div  id="${uuid}" class="positionBoxLeftFour"></div></div>
                                </div>
                                <div class="right">
                                    <div class="item" data-len="3" data-leftMin="5" data-top="0" title="${conditionformat_Text.threeWayArrow}(${conditionformat_Text.grayColor})"><div  id="${uuid}" class="positionBoxRightOne"></div></div>
                                    <div class="item" data-len="4" data-leftMin="5" data-top="1" title="${conditionformat_Text.fourWayArrow}(${conditionformat_Text.grayColor})"><div  id="${uuid}" class="positionBoxRightTwo"></div></div>
                                    <div class="item" data-len="5" data-leftMin="5" data-top="2" title="${conditionformat_Text.fiveWayArrow}(${conditionformat_Text.grayColor})"><div  id="${uuid}" class="positionBoxRightThree"></div></div>
                                </div>
                                <div  id="${uuid}" class="positionClear"></div>
                            </div>
                            <div class="title">${conditionformat_Text.shape}</div>
                            <div class="list">
                                <div class="left">
                                    <div class="item" data-len="3" data-leftMin="0" data-top="4" title="${conditionformat_Text.threeColorTrafficLight}(${conditionformat_Text.rimless})"><div  id="${uuid}" class="titleOneLeftOne"></div></div>
                                    <div class="item" data-len="3" data-leftMin="0" data-top="5" title="${conditionformat_Text.threeSigns}"><div  id="${uuid}" class="titleOneLeftTwo"></div></div>
                                    <div class="item" data-len="4" data-leftMin="0" data-top="6" title="${conditionformat_Text.greenRedBlackGradient}"><div  id="${uuid}" class="titleOneLeftThree"></div></div>
                                </div>
                                <div class="right">
                                    <div class="item" data-len="3" data-leftMin="5" data-top="4" title="${conditionformat_Text.threeColorTrafficLight}(${conditionformat_Text.bordered})"><div  id="${uuid}" class="titleOneRightOne"></div></div>
                                    <div class="item" data-len="4" data-leftMin="5" data-top="5" title="${conditionformat_Text.fourColorTrafficLight}"><div  id="${uuid}" class="titleOneRightTwo"></div></div>
                                </div>
                                <div  id="${uuid}" class="positionClear"></div>
                            </div>
                            ...
                            <div class="list">
                                <div class="left">
                                    <div class="item" data-len="3" data-leftMin="0" data-top="7" title="${conditionformat_Text.threeSymbols}(${conditionformat_Text.circled})"><div  id="${uuid}" class="titleTwoLeftOne"></div></div>
                                    <div class="item" data-len="3" data-leftMin="0" data-top="8" title="${conditionformat_Text.tricolorFlag}"><div  id="${uuid}" class="titleTwoLeftOne"></div></div>
                                </div>
                                <div class="right">
                                    <div class="item" data-len="3" data-leftMin="5" data-top="7" title="${conditionformat_Text.threeSymbols}(${conditionformat_Text.noCircle})"><div  id="${uuid}" class="titleTwoRightOne"></div></div>
                                </div>
                                <div  id="${uuid}" class="positionClear"></div>
                            </div>
                            ...
                            <div class="list">
                                <div class="left">
                                    <div class="item" data-len="3" data-leftMin="0" data-top="9" title="${conditionformat_Text.threeStars}"><div  id="${uuid}" class="titleThreeLeftOne"></div></div>
                                    <div class="item" data-len="5" data-leftMin="0" data-top="10" title="${conditionformat_Text.fiveQuadrantDiagram}"><div  id="${uuid}" class="titleThreeLeftTwo"></div></div>
                                    <div class="item" data-len="5" data-leftMin="0" data-top="11" title="${conditionformat_Text.fiveBoxes}"><div  id="${uuid}" class="titleThreeLeftThree"></div></div>
                                </div>
                                <div class="right">
                                    <div class="item" data-len="4" data-leftMin="5" data-top="9" title="${conditionformat_Text.grade4}"><div  id="${uuid}" class="titleThreeRightOne"></div></div>
                                    <div class="item" data-len="5" data-leftMin="5" data-top="10" title="${conditionformat_Text.grade5}"><div  id="${uuid}" class="titleThreeRightTwo"></div></div>
                                </div>
                                <div  id="${uuid}" class="positionClear"></div>
                            </div>
                        </div>`;
  ...
  getConditionRuleList: function (index) {
    ...
    const uuid = getComputedInlineStyling(`
            &.canvasStyleOne {
             width: 46px;height: 18px;margin: 3px 0 0 5px;
            }   
              &.canvasStyleTwo {
              width: 46px;height: 18px;margin: 3px 0 0 5px;
            }   
            ...
            &.conditionFormatOne {
              background-color:${format["textColor"]};
            }   
            &.conditionFormatTwo {
            background-color:${format["cellColor"]};
            }   
            `);
    ...
    if (ruleArr != null && ruleArr.length > 0) {
      ...
      for (let i = 0; i < ruleArr.length; i++) {
        ...
        if (type == "dataBar") {
          ...
          formatHtml = `<canvas width="46" height="18" id="${uuid}" class="canvasStyleOne"></canvas>`;
        } else if (type == "colorGradation") {
          ruleName = conditionformat_Text.colorGradation;

          formatHtml = `<canvas width="46" height="18" id="${uuid}" class="canvasStyleTwo"></canvas>`;
        } else if (type == "icons") {
          ruleName = conditionformat_Text.icons;

          formatHtml = `<canvas width="46" height="18" id="${uuid}" class="canvasStyleThree"></canvas>`;
        } else {
          ...
          if (format["textColor"] != null) {
            formatHtml +=
              ...
              `id="${uuid}" class="conditionFormatOne"></span>`;
          }
  ...
  getRuleExplain: function (index) {
    ...
    const uuid = getComputedInlineStyling(`
            &.wrapperRule {
             height: 30px;margin-bottom: 5px;
              ...
              &.labelRule {
              display: block;width: 80px;height: 30px;line-height: 30px;float: left;
            }   
              &.canvasStyleThree {
            width: 46px;height: 18px;margin: 3px 0 0 5px;
            }   
    ...
    background-position: -131px -100px;
       ...
       background-position: 0 -120px;
               ...
               &.conditionListThirteen {
         background-position: 0 -140px;
            }
               &.conditionListFourteen {
           background-position: -131px -140px;
            }
               &.conditionListFiveteen {
        background-position: 0 -160px;
            }
               &.conditionListSixteen {
         background-position: 0 -180px;
            }
               &.conditionListSevenTeen {
 background-position: 0 -200px;
            }
               &.conditionListEightteen {
         background-position: 0 -220px;
            }
               &.conditionListNineTeen {
        background-position: -131px -180px;
            }
               &.conditionListTweenty {
            background-position: -131px -200px;
            }
    ...
    switch (index) {
      case 0: //基于各自值设置所有单元格的格式
        ruleExplainHtml = `<div class="title">${conditionformat_Text.ruleTypeItem1}：</div>
                                    <div id="${uuid}" class="wrapperRule">
                                        <label id="${uuid}" class="labelRule">${conditionformat_Text.formatStyle}：</label>
                                        <select id="type1">
                                    ...
                                    <div>
                                        <div class="type1Box dataBarBox">
                                            <div id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.fillType}：</label>
                                                <select id="type2">
                                            ...
                                            <div id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.color}：</label>
                                                <input data-tips="${conditionformat_Text.dataBarColor}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="#638ec6" id="${uuid}" class="display-none"> 
                                            </div>
                                        </div>
                                        <div class="type1Box colorGradationBox" id="${uuid}" class="display-none">
                                            <div id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.fillType}：</label>
                                                <select id="type2">
                                            ...
                                            <div class="maxVal" id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.maxValue}：</label>
                                                <input data-tips="${conditionformat_Text.maxValue} ${conditionformat_Text.color}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="rgb(99, 190, 123)" id="${uuid}" class="display-none">
                                            </div>
                                            <div class="midVal" id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.medianValue}：</label>
                                                <input data-tips="${conditionformat_Text.medianValue} ${conditionformat_Text.color}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="rgb(255, 235, 132)" id="${uuid}" class="display-none">
                                            </div>
                                            <div class="minVal" id="${uuid}" class="wrapperRule">
                                                <label id="${uuid}" class="labelRule">${conditionformat_Text.minValue}：</label>
                                                <input data-tips="${conditionformat_Text.minValue} ${conditionformat_Text.color}" data-func="background" class="luckysheet-conditionformat-config-color" type="text" value="rgb(248, 105, 107)" id="${uuid}" class="display-none">
                                            </div>
                                        </div>
                                        <div class="type1Box iconsBox" id="${uuid}" class="display-none">
                                            <label>${conditionformat_Text.fillType}：</label>
                                            <div class="showbox">
                                                <div class="model" data-len="3" data-leftmin="0" data-top="0" title="${conditionformat_Text.threeWayArrow}(${conditionformat_Text.multicolor})" id="${uuid}" class="showBoxModel"></div>
                                                <span class="ui-selectmenu-icon ui-icon ui-icon-triangle-1-s" id="${uuid}" class="showBoxModelUI"></span>
                                            </div>
                                            <ul>
                                                <li><div data-len="3" data-leftmin="0" data-top="0" title="${conditionformat_Text.threeWayArrow}(${conditionformat_Text.multicolor})" id="${uuid}" class="conditionListOne"></div></li>
                                                <li><div data-len="3" data-leftmin="5" data-top="0" title="${conditionformat_Text.threeWayArrow}(${conditionformat_Text.grayColor})"  id="${uuid}" class="conditionListTwo"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="1" title="${conditionformat_Text.threeTriangles}"  id="${uuid}" class="conditionListThree"></div></li>
                                                <li><div data-len="4" data-leftmin="0" data-top="2" title="${conditionformat_Text.fourWayArrow}(${conditionformat_Text.multicolor})"  id="${uuid}" class="conditionListFour"></div></li>
                                                <li><div data-len="4" data-leftmin="5" data-top="1" title="${conditionformat_Text.fourWayArrow}(${conditionformat_Text.grayColor})"  id="${uuid}" class="conditionListFive"></div></li>
                                                <li><div data-len="5" data-leftmin="0" data-top="3" title="${conditionformat_Text.fiveWayArrow}(${conditionformat_Text.multicolor})"  id="${uuid}" class="conditionListSix"></div></li>
                                                <li><div data-len="5" data-leftmin="5" data-top="2" title="${conditionformat_Text.fiveWayArrow}(${conditionformat_Text.grayColor})"  id="${uuid}" class="conditionListSeven"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="4" title="${conditionformat_Text.threeColorTrafficLight}(${conditionformat_Text.rimless})"  id="${uuid}" class="conditionListEight"></div></li>
                                                <li><div data-len="3" data-leftmin="5" data-top="4" title="${conditionformat_Text.threeColorTrafficLight}(${conditionformat_Text.bordered})"  id="${uuid}" class="conditionListNine"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="5" title="${conditionformat_Text.threeSigns}"  id="${uuid}" class="conditionListTen"></div></li>
                                                <li><div data-len="4" data-leftmin="5" data-top="5" title="${conditionformat_Text.fourColorTrafficLight}" id="${uuid}" class="conditionListEleven"></div></li>
                                                <li><div data-len="4" data-leftmin="0" data-top="6" title="${conditionformat_Text.greenRedBlackGradient}"  id="${uuid}" class="conditionListTwelve"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="7" title="${conditionformat_Text.threeSymbols}(${conditionformat_Text.circled})"  id="${uuid}" class="conditionListThirteen"></div></li>
                                                <li><div data-len="3" data-leftmin="5" data-top="7" title="${conditionformat_Text.threeSymbols}(${conditionformat_Text.noCircle})"  id="${uuid}" class="conditionListFourteen"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="8" title="${conditionformat_Text.tricolorFlag}"  id="${uuid}" class="conditionListFiveteen"></div></li>
                                                <li><div data-len="3" data-leftmin="0" data-top="9" title="${conditionformat_Text.threeStars}"  id="${uuid}" class="conditionListSixteen"></div></li>
                                                <li><div data-len="5" data-leftmin="0" data-top="10" title="${conditionformat_Text.fiveQuadrantDiagram}"  id="${uuid}" class="conditionListSeventeen"></div></li>
                                                <li><div data-len="5" data-leftmin="0" data-top="11" title="${conditionformat_Text.fiveBoxes}"  id="${uuid}" class="conditionListEightteen"></div></li>
                                                <li><div data-len="4" data-leftmin="5" data-top="9" title="${conditionformat_Text.grade4}"  id="${uuid}" class="conditionListNineteen"></div></li>
                                                <li><div data-len="5" data-leftmin="5" data-top="10" title="${conditionformat_Text.grade5}"  id="${uuid}" class="conditionListTwenty"></div></li>
                                            </ul>
                                        </div>
                                    </div>`;
        break;
                                    ...
                                    <div id="${uuid}" class="titleBox">
                                        ...
                                        <div>
                                            <div class="type1Box numberBox">
                                                ...
                                                <span class="txt" id="${uuid}" class="display-none">${conditionformat_Text.in}</span>
                                                <div class="inpbox range" id="conditionVal2" id="${uuid}" class="display-none">
                                                    <input class="formulaInputFocus"/>
                                                    <i class="fa fa-table" aria-hidden="true" title="${conditionformat_Text.selectDataRange}"></i>
                                                </div>
                                            </div>
                                            <div class="type1Box textBox" id="${uuid}" class="display-none">
                                                <select id="type2">
                                            ...
                                            <div class="type1Box dateBox" id="${uuid}" class="display-none">
                                                <div  class="inpbox dateBoxLayoutOne" id="${uuid}">
                                                    <input id="daterange-btn" readonly="readonly" placeholder="${conditionformat_Text.pleaseSelectADate}" class="${uuidInline} dateBoxLayoutTwo"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
      ...
      case 5: //使用公式确定要设置格式的单元格
        ruleExplainHtml = `<div class="title">${conditionformat_Text.ruleTypeItem2_title}：</div>
                                    <div  id="${uuid}" class="titleBox">
                                        <div class="inpbox range ${uuidInline} titleBoxDateOne" id="formulaConditionVal">
                                            <input class="formulaInputFocus titleBoxDateTwo"  id="${uuid}"/>
                                            <i class="fa fa-table" aria-hidden="true" title="${conditionformat_Text.selectCell}"></i>
                                        </div>
                                    </div>
                                    <div class="title">${conditionformat_Text.setFormat}: </div>${textCellColorHtml}`;
