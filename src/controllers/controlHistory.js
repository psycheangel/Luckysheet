...
const controlHistory = {
  redo: function (e) {
    ...
    if (ctr.type == "datachange") {
      ...
      server.saveParam("all", ctr.sheetIndex, ctr.zoomRatio, {
        k: "zoomRatio",
      });
      zoomNumberDomBind();
      zoomRefreshView();
  ...
  undo: function () {
    ...
    if (ctr.type == "datachange") {
      ...
      server.saveParam("all", ctr.sheetIndex, ctr.curZoomRatio, {
        k: "zoomRatio",
      });
      zoomNumberDomBind();
      zoomRefreshView();
