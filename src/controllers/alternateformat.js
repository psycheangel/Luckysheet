...
const alternateformat = {
  ...
  getModelBox: function (hasRowHeader, hasRowFooter) {
    ...
    for (let i = 0; i < _this.FixedModelColor.length; i++) {
      ...
      &.modelInline_Three {
      color:${color3["fc"]};
      background-color:${color3["bc"]};
      }
      &.modelInline_Four {
      color:${color4["fc"]};
      background-color:${color4["bc"]};
      }
      `);
      ...
      modelListHtml +=
        ...
        '<span id="' +
        uuid +
        '" class="modelInline_One"> — </span>' +
        '<span id="' +
        uuid +
        '" class="modelInline_Two"> — </span>' +
        '<span id="' +
        uuid +
        '" class="modelInline_Three"> — </span>' +
        '<span id="' +
        uuid +
        '" class="modelInline_Four"> — </span>' +
        "</div>" +
        "</div>";
    }
        ...
        function () {
          ...
          const uuid = getComputedInlineStyling(`
            ...
            color:${currenColor};
             ...
             &.toningShowTwo {
            border-bottom-color:${currenColor};
            }
              &.toningShowThree {
          ...
          if (source == "0") {
            if (colorType == "fc") {
              ...
              $(
                ...
                .attr("id", uuid)
                .attr("class", "toningShowTwo");
            }
            if (colorType == "bc") {
              $("#luckysheet-alternateformat-modelToning .header .toningShow")
                .attr("id", uuid)
                .attr("class", "toningShowThree");
              $(
                "#luckysheet-alternateformat-modelToning .header .toningShow"
              ).data("bc", currenColor);
              $(
            ...
            if (colorType == "fc") {
              ...
              $(
                ...
                .parents(".luckysheet-color-menu-button-indicator")
                .attr("id", uuid)
                .attr("class", "toningShowSix");
            }
            if (colorType == "bc") {
              $("#luckysheet-alternateformat-modelToning .ctOne .toningShow")
                .attr("id", uuid)
                .attr("class", "toningShowSeven");
            ...
            if (colorType == "fc") {
              ...
              $(
                ...
                .attr("id", uuid)
                .attr("class", "toningShowTen");
            }
            if (colorType == "bc") {
              $("#luckysheet-alternateformat-modelToning .ctTwo .toningShow")
                .attr("id", uuid)
                .attr("class", "toningShowEleven");
              $(
                "#luckysheet-alternateformat-modelToning .ctTwo .toningShow"
              ).data("bc", currenColor);
              $(
                ...
                .attr("id", uuid)
                .attr("class", "toningShowTwelve");
            }
          } else if (source == "3") {
            if (colorType == "fc") {
              $("#luckysheet-alternateformat-modelToning .footer .toningShow")
                .attr("id", uuid)
                .attr("class", "toningShowThirteen");
              $(
                "#luckysheet-alternateformat-modelToning .footer .toningShow"
              ).data("fc", currenColor);
              $(
                ...
                .parents(".luckysheet-color-menu-button-indicator")
                .attr("id", uuid)
                .attr("class", "toningShowFourteen");
            }
            if (colorType == "bc") {
              $("#luckysheet-alternateformat-modelToning .footer .toningShow")
                .attr("id", uuid)
                .attr("class", "toningShowFiveteen");
              $(
                "#luckysheet-alternateformat-modelToning .footer .toningShow"
              ).data("bc", currenColor);
              $(
  ...
  modelToningColor: function () {
    ...
    const uuid = getComputedInlineStyling(`
            ...
            background-color: ${format["head"].bc},
             ...
             &.toningShowTwo {
            border-bottom-color: ${format["head"].fc},
            }
            &.toningShowThree {
            border-bottom-color: ${format["head"].bc},
            }
            &.toningShowFour {
              color: ${format["one"].fc},
              background-color: ${format["one"].bc},
                ...
                &.toningShowFive {
         border-bottom-color: ${format["one"].fc},
            }
              &.toningShowSix {
          border-bottom-color: ${format["one"].bc},
            }
               &.toningShowSeven {
               color: ${format["two"].fc},
        background-color: ${format["two"].bc},
              ...
              &.toningShowEight {
        border-bottom-color:${format["foot"].fc}
            }
               &.toningShowNine {
        border-bottom-color: ${format["foot"].bc}
            }
        &.toningShowTen {
