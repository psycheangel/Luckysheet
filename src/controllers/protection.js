      ...
      content: `
            <div class="luckysheet-protection-rangeItem-content">
                <div class="luckysheet-slider-protection-row">
                    ...
                    <div class="luckysheet-slider-protection-column luckysheet-protection-column-7x positionLeft" id="${uuid}">
...
margin-top:20px;
  ...
  for (let i = 0; i < authorityItemArr.length; i++) {
    ...
    authorityItemHtml += `
            <div class="luckysheet-slider-protection-row layoutHeight" id="${uuid}">
  ...
  const protectionModalHtml = `
    <div id="luckysheet-modal-dialog-slider-protection" class="luckysheet-modal-dialog-slider luckysheet-modal-dialog-slider-pivot displayNone ${uuidInline}">
        ...
        <div class="luckysheet-modal-dialog-slider-content">
            <div class="luckysheet-slider-protection-config ${uuidInline} layoutPositionTop" style="top:10px;height:115px">
                <div class="luckysheet-slider-protection-row">
                    <div class="luckysheet-slider-protection-column luckysheet-protection-column-10x">
                ...
                <div class="luckysheet-slider-protection-row layoutHeightOne" id="${uuid}">
                    <div class="luckysheet-slider-protection-column layoutTwo" id="${uuid}">
                        <input class="luckysheet-protection-input" id="protection-password"  placeHolder="${local_protection.enterPassword}">
                    </div>
                </div>
                <div class="luckysheet-slider-protection-row" layoutOne" id="${uuid}">
                    <div class="luckysheet-slider-protection-column layoutTwo" id="${uuid}">
                        <textarea class="luckysheet-protection-textarea" id="protection-hint"  placeHolder="${local_protection.enterHint}"></textarea>
                    </div>
                </div>
            </div>
            <div class="luckysheet-slider-protection-config layoutBorder" id="${uuid}">
                <div class="luckysheet-slider-protection-row layoutThree" id="${uuid}">
                    ${local_protection.authorityTitle}
                </div>
                ${authorityItemHtml}
            </div>
            <div class="luckysheet-slider-protection-config layoutBorderOne" id="${uuid}">
                <div class="luckysheet-slider-protection-row layoutHeightTwo" id="${uuid}">
                    <div class="luckysheet-slider-protection-column luckysheet-protection-column-7x layoutFour" id="${uuid}">
                        ${local_protection.allowRangeTitle}
                    </div>
                    <div class="luckysheet-slider-protection-column luckysheet-protection-column-3x layoutFive" id="${uuid}">
                ...
                <div id="luckysheet-protection-rangeItem-container" class="luckysheet-slider-protection-row ${uuidInline} layoutPositionAbsolute" >
                   
                </div>
            </div>
            <div class="luckysheet-slider-protection-config layoutSix" id="${uuid}">
                <div class="luckysheet-slider-protection-column luckysheet-protection-column-5x layoutSeven" id="${uuid}" >
                    <div class="luckysheet-slider-protection-ok" id="luckysheet-slider-protection-ok">
                        ${locale_button.confirm}
                    </div>
                </div>
                <div class="luckysheet-slider-protection-column luckysheet-protection-column-5x layoutEight" id="${uuid}">
  ...
  $("body").append(
    replaceHtml(modelHTML, {
      ...
      content: `
            ...
            <div class="luckysheet-slider-protection-row layoutNine" id="${uuid}">
                <div class="luckysheet-slider-protection-column luckysheet-protection-column-10x">
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        content: `
                ...
                <div class="luckysheet-slider-protection-row layout" id="${uuid}" >
                    <div class="luckysheet-slider-protection-column luckysheet-protection-column-10x">
                        <input type="password" class="luckysheet-protection-rangeItemiInput" placeHolder="${local_protection.validationInputHint}">
                    </div>
                </div>
