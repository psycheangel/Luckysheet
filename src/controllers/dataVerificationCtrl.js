...
const dataVerificationCtrl = {
  ...
  createDialog: function () {
    ...
    let content = `<div class="box">
                            <div class="box-item ${uuidInline} layout">
    ...
    let $t = $("#luckysheet-dataVerification-dialog")
        ...
        .addclass(uuidInlineTwo + " inlineOne")
        .end(),
      myh = $t.outerHeight(),
      myw = $t.outerWidth();
    ...
    $("#luckysheet-dataVerification-dialog")
      .addclass(uuidInlineThree + " inline")
      .show();
  ...
  rangeDialog: function (dataSource, txt) {
    ...
    let $t = $("#luckysheet-dataVerificationRange-dialog")
        .find(".luckysheet-modal-dialog-content")
        .addclass(uuidInlineFour + " inline")
        .end(),
      myh = $t.outerHeight(),
      myw = $t.outerWidth();
    let winw = $(window).width(),
    ...
    $("#luckysheet-dataVerificationRange-dialog")
      .addclass(uuidInlineFive + " inline")
      .show();
  },
  ...
  cellFocus: function (r, c, clickMode) {
    ...
    //单元格数据验证 类型是 下拉列表
    if (item.type == "dropdown") {
      const uuidInlineSix = getComputedInlineClassStyling(`
      &.inline {
    ...
    if (item.hintShow) {
      let hintText;
      const uuidInlineSeven = getComputedInlineClassStyling(`
      &.hint {
  color:#f5a623;
      }
      &.inline {
      ...
      `);
      if (Store.lang == "en") {
        hintText = `<span class="${uuidInlineSeven} hint">Hint: </span>`;
      } else {
        hintText = `<span  class="${uuidInlineSeven} hint">提示：</span>`;
      }
      ...
      $("#luckysheet-dataVerification-showHintBox")
        .html(hintText)
        .show()
        .addclass(uuidInlineSeven + " inline");
    ...
    if (!validate) {
      let failureText;
      const uuidInlineEight = getComputedInlineClassStyling(`
      &.hint {
  color:#f72626;
      }
      &.inline {
      ...
      `);
      if (Store.lang == "en") {
        failureText = `<span class="${uuidInlineEight} hint">Failure: </span>`;
      } else {
        failureText = `<span class="${uuidInlineEight} hint">失效：</span>`;
      }
      ...
      $("#luckysheet-dataVerification-showHintBox")
        .html(failureText)
        .show()
        .addclass(uuidInlineEight + " inline");
    }
  },
  ...
  dropdownListShow: function () {
    ...
    const uuidInlineNine = getComputedInlineClassStyling(`
      &.inline {
   width: ${col - col_pre - 1}px;
    ...
    $("#luckysheet-dataVerification-dropdown-List")
      ...
      .show()
      .addclass(uuidInlineNine + " inline");
    ...
    if (row + myh > currentWinH - 42 - 6) {
      const uuidInlineTen = getComputedInlineClassStyling(`

      &.inline {
        top: ${row_pre - myh}px;
      }
      `);
      $("#luckysheet-dataVerification-dropdown-List").addclass(
        uuidInlineTen + " inline"
      );
    }
  },
