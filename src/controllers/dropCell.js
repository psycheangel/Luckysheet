...
const uuidInline = getComputedInlineClassStyling(`
      &.inlineOne {
position: absolute;padding: 2px;background-color: #f1f1f1;z-index: 990;cursor: pointer;
      }
   &.inlineTwo {
   padding: 3px 2px;
   }
   &.inlineThree {
   margin-right:5px;width:13px;display:inline-block;
   }
   &.inlineFour {
   }
      `);
...
const luckysheetDropCell = {
  iconHtml:
    `<div id="luckysheet-dropCell-icon" class="${uuidInline} inlineOne">` +
  ...
  typeListHtml:
    ...
    `<div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel ${uuidInline} inlineTwo">` +
    '<span class="icon luckysheet-mousedown-cancel ' +
    uuidInline +
    ' inlineThree"></span>${copyCell}' +
    "</div>" +
    "</div>" +
    ...
    '<span class="icon luckysheet-mousedown-cancel ' +
    uuidInline +
    ' inlineThree"></span>${chineseNumber}' +
    "</div>" +
    "</div>" +
    "</div>",
  copyRange: {}, //复制范围
  ...
  createIcon: function () {
    ...
    $("#luckysheet-dropCell-icon").addClass(uuidInline + " inline");
    ...
    $("#luckysheet-dropCell-icon")
      ...
      `);
        ...
        $(this).addClass(uuidInline + " inline");
      })
      .mouseleave(function () {
        const uuidInline = getComputedInlineClassStyling(`
      &.inline {
    ...
    $(document)
      ...
      `);
          ...
          $("#luckysheet-dropCell-icon").addClass(uuidInline + " inline");
          $("#luckysheet-dropCell-icon").mouseleave(function () {
            $(this).addClass(uuidInline + " inlineTwo");
          });
