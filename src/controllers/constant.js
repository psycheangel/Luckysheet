...
const gridHTML = function () {
  ...
  const uuid = getComputedInlineStyling(`
    &.italicLucky{
    ...
    &.display-visibility-tooltip {
    visibility: visible; width: 149px;
    }
    &.color-semi {
    color:#333
    }
    ...
    &.stylingThree {
    display:none;padding:0;position:absolute;z-index:300;
    }
    &.stylingFour {
  ...
  const userInfo =
    luckysheetConfigsetting.userInfo === true
      ? `<i id="${uuid}" class="fa fa-taxi italicLucky" aria-hidden="true"></i> Lucky`
  ...
  return `<div class="luckysheet">
                    <canvas id="luckysheetTableContentF" id="${uuid}" class="display-none luckysheetTableContent"></canvas> 
                        ...
                        <div id ="luckysheet_info_detail" class="luckysheet_info_detail"> 
                            <div data-tips="${
                              locale_info.return
                                ...
                                <i id="${uuid}" class="italicdetailtitle" class="fa fa-angle-left fa-2x" aria-hidden="true"></i> 
                            </div> 
    ...
    locale_info.rename
  }" id="${uuid}" class="display-visibility-tooltip" data-tooltip="${
    locale_info.rename
  }"> 
                            </div> 
                        ...
                        <div id="luckysheet-wa-calculate" class="luckysheet-wa-calculate"> 
                            ...
                            <div id="luckysheet-wa-functionbox-fx" class="luckysheet-wa-functionbox">
                                <span><i class="iconfont-luckysheet luckysheet-iconfont-hanshu" aria-hidden="true" id="${uuid}" class="color-semi"></i></span> 
                            </div> 
                                            ...
                                            <td valign="top" class="luckysheet-paneswrapper">
                                                ...
                                                <div class="luckysheet-cell-main " id="luckysheet-cell-main">
                                                    ...
                                                    <div id="luckysheet-image-showBoxs">
                                                        <div id="luckysheet-modal-dialog-activeImage" class="luckysheet-modal-dialog stylingOne ${uuidInline}" >
                                                            <div class="luckysheet-modal-dialog-border" id="${uuid}" class="stylingTwo"></div> 
                                                        ...
                                                        <div id="luckysheet-modal-dialog-cropping" class="luckysheet-modal-dialog stylingThree ${uuidInline}">
                                                            <div class="cropping-mask"></div>
                                                            <div class="cropping-content"></div>
                                                            <div class="luckysheet-modal-dialog-border stylingTwo" id="${uuid}" ></div>
                                                            <div class="luckysheet-modal-dialog-resize">
                            ...
                            <div class="luckysheet-sheet-area luckysheet-noselected-text" id="luckysheet-sheet-area">
                                <div id="luckysheet-sheet-content">
                                    ...
                                    <div class="luckysheet-sheet-container" id="luckysheet-sheet-container">
                                        <div class="docs-sheet-fade docs-sheet-fade-left display-none" id="${uuid}">
                                            <div class="docs-sheet-fade3"></div>
                                            <div class="docs-sheet-fade2"></div>
                                            <div class="docs-sheet-fade1"></div>
                                        </div>
                                        <div class="docs-sheet-fade docs-sheet-fade-right display-none" id="${uuid}>
                                            <div class="docs-sheet-fade1"></div>
                                            <div class="docs-sheet-fade2"></div>
                                            <div class="docs-sheet-fade3"></div>
                                        </div>
                    ...
                    <div id="testdpidiv" class="${uuidInline} stylingFour"></div>
                  </div>`;
};
...
const columeHeader_word = [
  ...
  flow =
    '<div id="luckysheet-cell-flow_${index}" class="luckysheet-cell-flow luckysheetsheetchange ' +
    uuidInlineTwo +
    ' layout"' +
    '><div class="luckysheet-cell-flow-clip"><div class="luckysheet-grdblkpush"></div>${flow}</div></div>',
  colsmenuHTML = "";
...
function rightclickHTML() {
  ...
  const uuidInline = getComputedInlineClassStyling(`
    ...
    &.handleCellMenuDisplayNone {
    display:${handleincellMenuseparator ? "block" : "none"};
    }
  &.select-none {
  user-select: none;
  }
  &.inlineStyleOne {
width:40px;height:20px;box-sizing:border-box;text-align:center;margin-left:5px;
}

&.inlineStyleTwo {
width:50px;height:20px;box-sizing:border-box;text-align: center;margin-left:5px;
}

&.inlineStyleThree {
width:40px;height:20px;box-sizing:border-box;text-align: center;
}

&.inlineStyleFour {
margin-left:5px;padding:2px 3px;line-height:12px;font-size:12px;
}
...
&.displaySortLogical {
display:${config.sort ? "block" : "none"};
}

&.displaySelectHighlight {
display:${config.selectHighlight ? "block" : "none"};
}
  ...
  const rightclickContainer = `<div id="luckysheet-rightclick-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel">
                <div id="luckysheet-copy-btn" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel luckysheet-copy-btn ${uuidInline} display-none" data-clipboard-action="copy" data-clipboard-target="#luckysheet-copy-content">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.copy}</div>
                </div>
                <div id="luckysheetcopyfor" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel  ${uuidInline} display-none">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.copyAs}<span class="luckysheet-submenu-arrow iconfont-luckysheet luckysheet-iconfont-youjiantou  ${uuidInline} display-none"></span>
                    </div>
                </div>
                <div id="luckysheet-copy-paste" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel  ${uuidInline} display-none">
                ...
                <div id="luckysheet-cols-rows-handleincell">
                    <div class="luckysheet-menuseparator luckysheet-mousedown-cancel ${uuidInline} handleCellMenuDisplayNone" role="separator"></div>
                    <div id="luckysheetColsRowsHandleAdd_row" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.insert}${rightclick.row}<span class="luckysheet-submenu-arrow ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    <div id="luckysheetColsRowsHandleAdd_column" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.insert}${rightclick.column}<span class="luckysheet-submenu-arrow ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    <div id="luckysheet-delRows" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.deleteSelected}${rightclick.row}<span class="luckysheet-submenu-arrow ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    <div id="luckysheet-delCols" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.deleteSelected}${rightclick.column}<span class="luckysheet-submenu-arrow ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    ...
                    <div id="luckysheetColsRowsHandleHid" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.hide}<span class="luckysheet-submenu-arrow iconfont-luckysheet luckysheet-iconfont-youjiantou ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    -->
                    <div id="luckysheetCellsHandleDel" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.deleteCell}<span class="luckysheet-submenu-arrow iconfont-luckysheet luckysheet-iconfont-youjiantou ${uuidInline} select-none"></span>
                        </div>
                    </div>
                </div>
                <div id="luckysheet-cols-rows-add">
                    ...
                    <div id="luckysheet-top-left-add-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ...
                            ${rightclick.add}
                            <input type="text" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleOne" placeholder="${rightclick.number}" value="1"/>
                    ...
                    <div id="luckysheet-column-row-width-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ...
                            <input type="number" class="luckysheet-mousedown-cancel rcsize ${uuidInline} inlineStyleTwo" min="0" max="255" placeholder="${rightclick.number}" value="">
                            px
                        </div>
                    </div>
                </div>
                <div id="luckysheet-cols-rows-shift">
                    <div class="luckysheet-menuseparator luckysheet-mousedown-cancel ${uuidInline} display-none" role="separator"></div>
                    <div id="luckysheetorderbyasc" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.orderAZ}</div>
                    </div>
                    <div id="luckysheetorderbydesc" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none" >
                ...
                <div id="luckysheet-cols-rows-data">
                    <div class="luckysheet-menuseparator luckysheet-mousedown-cancel ${uuidInline} display-none" role="separator"></div>
                    <div id="luckysheet-delete-text" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.clearContent}</div>
                    </div>
                    <div id="luckysheetmatrix" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ${rightclick.matrix}<span class="luckysheet-submenu-arrow iconfont-luckysheet luckysheet-iconfont-youjiantou ${uuidInline} select-none"></span>
                        </div>
                    </div>
                    <div id="luckysheetorderby" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displaySortLogical ">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.sortSelection}</div>
                    </div>
                     <div id="luckysheetselected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displaySelecthighlight">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.selectHighlight}</div>
                    </div>
                    <div id="luckysheetfilter" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.filterSelection}</div>
                    </div>
                    <div id="luckysheetdatavisual" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.chartGeneration}</div>
                    </div>
                    <div id="luckysheetInsertImage" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none" >
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${toolbar.insertImage}</div>
                    </div>
                    <div id="luckysheetInsertLink" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${toolbar.insertLink}</div>
                    </div>
                    <div id="luckysheetDataVerification" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${toolbar.dataVerification}</div>
                    </div>
                    <div id="luckysheetCellFormatRightClickMenu" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} display-none">
            ...
            <div id="luckysheetcopyfor_sub" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-rightgclick-menu-sub luckysheet-mousedown-cancel">
                ...
                <div id="luckysheet-copy-arraymore-confirm" data-clipboard-action="copy" data-clipboard-target="#luckysheet-copy-content" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ...
                        <input type="number" id="luckysheet-copy-arraymore-row" min="1" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleThree " placeholder="${rightclick.row}"/>
                            ×
                            <input type="number" id="luckysheet-copy-arraymore-col" min="1" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleThree " placeholder="${rightclick.column}"/>
                    </div>
                </div>
                <div class="luckysheet-menuseparator luckysheet-mousedown-cancel" role="separator"></div>
                ...
                <div id="luckysheet-copy-diagonaloffset" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ...
                        <input type="number" id="luckysheet-copy-diagonaloffset-value" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleOne" placeholder="${rightclick.offset}" value="1" />
                        ${rightclick.column}
                    </div>
                </div>
            ...
            <div id="luckysheetmatrix_sub" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-rightgclick-menu-sub luckysheet-mousedown-cancel">
                <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.flip}
                        <button id="luckysheet-matrix-turn-up" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.upAndDown}</button>
                        <button id="luckysheet-matrix-turn-left" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.leftAndRight}</button>
                    </div>
                </div>
                <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.flip}
                        <button id="luckysheet-matrix-turn-cw" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.clockwise}</button>
                        <button id="luckysheet-matrix-turn-anticw" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.counterclockwise}</button>
                    </div>
                </div>
                <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                ...
                <div id="luckysheet-matrix-cal-confirm" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ...
                        <div class="luckysheet-mousedown-cancel">
                            <select id="luckysheet-matrix-cal-type" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">
                            ...
                            <input type="number" id="luckysheet-matrix-cal-value" class="luckysheet-mousedown-cancel ${uuidInline} inlineStyleOne" placeholder="${rightclick.number}" value="2"/>
                        </div>
                    </div>
                </div>
                <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.delete0}
                        <button id="luckysheet-matrix-delezero-row" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.byRow}</button>
                        <button id="luckysheet-matrix-delezero-column" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.byCol}</button>
                    </div>
                </div>
                <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                        ${rightclick.removeDuplicate}
                        <button id="luckysheet-matrix-delerpt-row" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.byRow}</button>
                        <button id="luckysheet-matrix-delerpt-column" class="btn btn-primary luckysheet-mousedown-cancel ${uuidInline} inlineStyleFour">${rightclick.byCol}</button>
                    </div>
                </div>
            </div>`;
...
const pivottableconfigHTML = function () {
  ...
  return (
    ...
    `</span> <select class="luckysheet-mousedown-cancel pivotInline ${uuidInline}" id="luckysheet-pivotTable-config-option-order"> <option selected="selected" value="default">` +
    ...
    `</span> <select class="luckysheet-mousedown-cancel pivotInline ${uuidInline}" id="luckysheet-pivotTable-config-option-orderby"> </select> </div> </div> </div> <div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel"> <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel"> <div class="luckysheet-mousedown-cancel"> <span class="luckysheet-mousedown-cancel">` +
    locale_pivotTable.titleShowSum +
    `</span> <select class="luckysheet-mousedown-cancel pivotInline ${uuidInline}" id="luckysheet-pivotTable-config-option-stastic"> <option  value="0">` +
...
const pivottablesumHTML = function () {
  ...
  return (
    ...
    `</span> <span class="luckysheet-submenu-arrow luckysheet-mousedown-cancel" select-none ${uuidInline}" ><i class="fa fa-check luckysheet-mousedown-cancel" aria-hidden="true"></i></span> </div> </div> </div>`
  );
};
...
const sheetHTML =
    '<div id="luckysheet-sheets-item${index}" data-index="${index}" class="luckysheet-sheets-item ${active} ' +
    uuidInline +
    ' display-style"><span class="luckysheet-sheets-item-name" spellcheck ="false" contenteditable="false">${name}</span> <span class="luckysheet-sheets-item-menu luckysheet-mousedown-cancel"><i class="fa fa-sort-desc luckysheet-mousedown-cancel"></i></span>${colorset}</div>',
  columnHeaderHTML =
    '<div class="luckysheet-cols-h-cells luckysheetsheetchange ' +
    uuidInline +
    ' width-style"  id="luckysheet-cols-h-cells_${index}"> <div class="luckysheet-cols-h-cells-c"> <div class="luckysheet-grdblkpush"></div>${column}</div></div>',
  sheetselectlistHTML =
  ...
  sheetselectlistitemHTML =
    '<div class="luckysheet-cols-menuitem luckysheet-mousedown-cancel"  id="luckysheet-sheet-btn${index}" data-index="${index}"><div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel ' +
    uuidInline +
    ' display-style"><span class="icon luckysheet-mousedown-cancel">${icon}</span>${name}</div></div>',
  inputHTML =
...
function sheetconfigHTML() {
  ...
  const uuidInline = getComputedInlineClassStyling(`
    &.displayDeleteLogical{
   display:${config.delete ? "block" : "none"};
    }

  &.displayCopyLogical{
 display:${config.copy ? "block" : "none"};
    }
     &.displayRenameLogical{
 display:${config.rename ? "block" : "none"};
    }

         &.displayColorLogical{
display:${config.color ? "block" : "none"};
    }
&.user-select {
user-select: none;
}
&.displayhideTopMenuseparator {
display:${hideTopMenuseparator ? "block" : "none"};
}
  &.displayHideLogical {
  display:${config.hide ? "block" : "none"};
  }
  &.displaymoveTopMenuSeperator {
 display:${moveTopMenuseparator ? "block" : "none"};
  }
  &.displayMoveLogical {
  
  display:${config.move ? "block" : "none"};
  }
    `);
  const sheetconfigModel = `<div id="luckysheet-rightclick-sheet-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel"> 
                <div id="luckysheetsheetconfigdelete" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayDeleteLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.delete}</div>
                </div> 
                <div id="luckysheetsheetconfigcopy" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayCopyLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.copy}</div> 
                </div> 
                <div id="luckysheetsheetconfigrename" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel  ${uuidInline} displayRenameLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.rename}</div> 
                </div> 
                <div id="luckysheetsheetconfigcolor" class="luckysheet-cols-menuitem luckysheet-cols-submenu luckysheet-mousedown-cancel  ${uuidInline} displayColorLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel"> 
                        ${sheetconfig.changeColor} <span class="luckysheet-submenu-arrow iconfont-luckysheet luckysheet-iconfont-youjiantou  ${uuidInline} user-select"></span> 
                    </div> 
                </div> 
                <div class="luckysheet-menuseparator luckysheet-mousedown-cancel" role="separator  ${uuidInline} displayhideTopMenuseparator"></div> 
                <div id="luckysheetsheetconfighide" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel  ${uuidInline} displayHideLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.hide}</div> 
                </div> 
                <div id="luckysheetsheetconfigshow" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayHideLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.unhide}</div> 
                </div> 
                <div class="luckysheet-menuseparator luckysheet-mousedown-cancel" role="separator ${uuidInline} displaymoveTopMenuSeperator"></div> 
                <div id="luckysheetsheetconfigmoveleft" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayMoveLogical"> 
                    <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${sheetconfig.moveLeft}</div> 
                </div> 
                <div id="luckysheetsheetconfigmoveright" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayMoveLogical"> 
...
const luckysheetPivotTableHTML = function () {
  ...
  const uuidInline = getComputedInlineClassStyling(`
   ...
   &.displayPadding {
   padding:0px 5px;margin:0px;font-size:12px;height:15px;line-height:15px;
   }
    `);
        ...
        <div class="luckysheet-modal-dialog-slider-content">
            ...
            <div class="luckysheet-modal-dialog-slider-config-c">
                ...
                <div class="luckysheet-modal-dialog-slider-config luckysheet-modal-dialog-config-value">
                    <div> <span><i class="fa fa-cube" aria-hidden="true"></i> ${locale_pivotTable.titleValue}</span> <span class="${uuidInline} displayFloat" id="luckysheetpivottablevaluecolrowshow"><label class="${uuidInline} displayPadding" title="${locale_pivotTable.tipShowColumn}" for="luckysheetpivottablevaluecolrow">${locale_pivotTable.titleColumn}</label> <input type="radio" checked="checked" value="1" name="luckysheetpivottablevaluecolrow" id="luckysheetpivottablevaluecolrow" /> <label class="${uuidInline} displayPadding" title="${locale_pivotTable.tipShowRow}" for="luckysheetpivottablevaluecolrow1">${locale_pivotTable.titleRow}</label> <input type="radio" value="0" name="luckysheetpivottablevaluecolrow" id="luckysheetpivottablevaluecolrow1" /></span></div>
...
function luckysheetAlternateformatHtml() {
  ...
  const uuidInline = getComputedInlineClassStyling(`
   ...
   &.borderOne {
   border-bottom-color: #000;margin-right: 10px;
   }
  ...
  return (
    `<div id="luckysheet-modal-dialog-slider-alternateformat" class="luckysheet-modal-dialog-slider luckysheet-modal-dialog-slider-alternateformat ${uuidInline} displayBlock">` +
    ...
    alternatingColors.header +
    " </div>" +
    `<div class="luckysheet-color-menu-button-indicator ${uuidInline} borderOne" title="` +
    alternatingColors.selectionTextColor +
    `> <div class="luckysheet-icon luckysheet-inline-block"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-text-color ${uuidInline} select-none"> </div> </div> </div>` +
    `<div class="luckysheet-color-menu-button-indicator ${uuidInline} borderTwo" title="` +
    alternatingColors.selectionCellColor +
    `"> <div class="luckysheet-icon luckysheet-inline-block"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-cell-color ${uuidInline} select-none"> </div> </div> </div>` +
    "</div>" +
    ...
    "</div>" +
    "</div>" +
    `<button id="luckysheet-alternateformat-remove" class="btn btn-default ${uuidInline} margin-layout">` +
...
const uuidInlineThree = getComputedInlineClassStyling(`
   &.displayPositionOne {
  left: 505px; top: 410px;
   }
   &.displayPostitionTwo {
  left: 35.5px;
   }
    &.layout {
   margin-bottom: 0px;margin-top: 0px;height: 30px;
...
&.layoutThree{
margin-bottom: 0px;margin-top: 3px;height: 30px;
...
&.layoutFive {
margin-bottom: 0px;margin-top: 5px;height: 30px;
...
&.layoutEight {
text-decoration:none;color:#8D8D8D;float:right;margin-right:40px;cursor:default;
...
&.layoutThirteen {
width:10%;margin-left:10px;text-align:center;margin-right: 2px;

}

&.layoutFourteen {
height:auto;line-height: initial;margin-left:auto;
...
const luckysheetloadingImage = function (config) {
  ...
  if (regResult !== null) {
    ...
    const uuidImageStr = getComputedInlineClassStyling(`
    &.displayImageStr {
      background-image: url(${imageStr});
    }
    `);

    switch (type) {
      case "image":
        imageHtml = `<div class="image-type ${uuidImageStr} displayImageStr"></div>`;
        break;
      case "path":
...
function customCellRightClickConfig() {
  const config = {
    ...
    matrix: false, // matrix operatcellRightClickConfigion selection
