...
const imageCtrl = {
  ...
  getSliderHtml: function () {
    ...
    const uuidInline = getComputedInlineClassStyling(`
      ...
      `);
    return `<div id="luckysheet-modal-dialog-slider-imageCtrl" class="luckysheet-modal-dialog-slider luckysheet-modal-dialog-slider-imageCtrl ${uuidInline} display-block" >
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        content: `<div class="currenColor">
                            ${locale_imageCtrl.borderCur}:<span title="${currenColor}" class="${uuidInline} display-color"></span>
                        </div>
