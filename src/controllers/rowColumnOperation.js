...
export function rowColumnOperationInitial() {
  ...
  $("#luckysheet-rows-h")
    ...
    .mousemove(function (event) {
      ...
      `);
      $("#luckysheet-rows-h-hover").addClass(uuidInline + " layout");

      if (y < row - 1 && y >= row - 5) {
        $("#luckysheet-rows-change-size").addClass(uuidInline + " layoutOne");
      } else {
        $("#luckysheet-rows-change-size").addClass(uuidInline + " layoutTwo");
      }
    })
    .mouseleave(function (event) {
      ...
      `);
      $("#luckysheet-rows-h-hover").hide();
      $("#luckysheet-rows-change-size").addClass(uuidInline + " layout");
    })
      ...
      if (event.which == 3) {
        ...
        const uuidInline = getComputedInlineClassStyling(`
         ...
         display:${cellRightClickConfig.rowHeight ? "block" : "none"};
          ...
          `);
        $("#luckysheet-top-left-add-selected").addClass(uuidInline + " layout");
        $("#luckysheet-bottom-right-add-selected").addClass(
          uuidInline + " layout"
        );
        $("#luckysheet-del-selected").addClass(uuidInline + " layoutOne");
        $("#luckysheet-hide-selected").addClass(uuidInline + " layoutTwo");
        $("#luckysheet-show-selected").addClass(uuidInline + " layoutTwo");
        $("#luckysheet-column-row-width-selected").addClass(
          uuidInline + " layoutThree"
        );
  ...
  $("#luckysheet-cols-h-c")
    ...
    .mousemove(function (event) {
      ...
      `);
      $("#luckysheet-cols-h-hover").addClass(uuidInline + " layout");
      $("#luckysheet-cols-menu-btn").addClass(uuidInline + " layoutOne");
      $("#luckysheet-cols-change-size").addClass(uuidInline + " layoutTwo");
      if (x < col && x >= col - 5) {
        $("#luckysheet-cols-change-size").addClass(uuidInline + " layoutThree");
        $("#luckysheet-cols-menu-btn").hide();
      } else {
    ...
    .mouseleave(function (event) {
      ...
      $("#luckysheet-cols-h-hover").hide();
      $("#luckysheet-cols-menu-btn").hide();
      $("#luckysheet-cols-change-size").addClass(uuidInline + " layout");
    })
    .mouseup(function (event) {
      if (event.which == 3) {
        // *如果禁止前台编辑，则中止下一步操作
  ...
  $("#luckysheet-rows-change-size").mousedown(function (event) {
    ...
    const uuidInlineOne = getComputedInlineClassStyling(`
      ...
      `);
    $("#luckysheet-change-size-line").addClass(uuidInlineOne + " layout");
    $(
  ...
  $("#luckysheet-cols-menu-btn").click(function (event) {
    ...
    const uuidInlineTwo = getComputedInlineClassStyling(`
         ...
         display:block;
          ...
          `);
    $("#luckysheet-cols-rows-add .luckysheet-menuseparator").addClass(
      uuidInlineTwo + " display-block"
    );
    $("#luckysheet-cols-rows-shift .luckysheet-menuseparator").addClass(
      uuidInlineTwo + " display-block"
    );
    ...
    const uuidInline = getComputedInlineClassStyling(`
         ...
         display:${cellRightClickConfig.columnWidth ? "block" : "none"};
          ...
          `);
    $("#luckysheet-top-left-add-selected").addClass(uuidInline + " layout");
    $("#luckysheet-bottom-right-add-selected").addClass(uuidInline + " layout");
    $("#luckysheet-del-selected").addClass(uuidInline + " layoutOne");
    $("#luckysheet-hide-selected").addClass(uuidInline + " layoutTwo");
    $("#luckysheet-show-selected").addClass(uuidInline + " layoutTwo");
    $("#luckysheet-column-row-width-selected").addClass(
