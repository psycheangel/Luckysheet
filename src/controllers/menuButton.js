...
const uuid = getComputedInlineStyling(`
  ...
  &.displayInlineBlock {
  margin-right:3px;width:13px;display:inline-block;
  }
  &.select-none {
  user-select: none;
  }
...
const menuButton = {
  ...
  // "item": '<div itemvalue="${value}" itemname="${name}" class="luckysheet-cols-menuitem ${sub} luckysheet-mousedown-cancel"><div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel" nonce="'+luckysheetConfigsetting.cspNonce+'" style="padding: 3px 0px 3px 1px;"><span nonce="'+luckysheetConfigsetting.cspNonce+'" style="margin-right:3px;width:13px;display:inline-block;" class="icon luckysheet-mousedown-cancel"></span> ${name} <span class="luckysheet-submenu-arrow luckysheet-mousedown-cancel" nonce="'+luckysheetConfigsetting.cspNonce+'" style="user-select: none;">${example}</span></div></div>',
  item:
    '<div itemvalue="${value}" itemname="${name}" class="luckysheet-cols-menuitem ${sub} luckysheet-mousedown-cancel"><div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel displayPadding" id="' +
    uuid +
    '"><span class="icon luckysheet-mousedown-cancel displayInlineBlock" id="' +
    uuid +
    '"></span> ${name} <span class="luckysheet-submenu-arrow luckysheet-mousedown-cancel select-none ${iconClass}" id="' +
    uuid +
...
background-color: ${color}
  ...
  `);
                let oldcolor = null;
                // $("#luckysheet-icon-text-color .luckysheet-color-menu-button-indicator").attr("nonce", luckysheetConfigsetting.cspNonce).css("border-bottom-color", color);
                // 下边框换成了一个DIV
                $("#luckysheet-icon-text-color .text-color-bar")
                  .addClass("displayBackgroundColor")
                  .attr("id", uuid);
...
background-color: ${color}
  ...
  `);
              let oldcolor = null;
              // $("#luckysheet-icon-cell-color .luckysheet-color-menu-button-indicator").attr("nonce", luckysheetConfigsetting.cspNonce).css("border-bottom-color", color);
              // 下边框换成了一个DIV
        ...
        let itemdata = [
          {
            ...
            value: "border-top",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="{uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-top iconfont-luckysheet luckysheet-iconfont-shangbiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_border.borderBottom,
            value: "border-bottom",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-bottom iconfont-luckysheet luckysheet-iconfont-xiabiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_border.borderLeft,
            value: "border-left",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-left iconfont-luckysheet luckysheet-iconfont-zuobiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
          ...
          { text: "", value: "split", example: "" },
          {
            ...
            value: "border-none",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-none iconfont-luckysheet luckysheet-iconfont-wubiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_border.borderAll,
            value: "border-all",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-all iconfont-luckysheet luckysheet-iconfont-quanjiabiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_border.borderOutside,
            value: "border-outside",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-outside iconfont-luckysheet luckysheet-iconfont-sizhoujiabiankuang select-none" id="${uuid}"> </div> </div>`,
          },
          { text: "", value: "split", example: "" },
          {
            text: locale_border.borderInside,
            value: "border-inside",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-inside iconfont-luckysheet luckysheet-iconfont-neikuangxian select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_border.borderHorizontal,
            value: "border-horizontal",
            example: `<div class="luckysheet-icon luckysheet-inline-block luckysheet-material-icon luckysheet-mousedown-cancel select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-border-horizontal iconfont-luckysheet luckysheet-iconfont-neikuanghengxian select-none" id="${uuid}"> </div> </div>`,
          },
          {
...
border-bottom-color: ${color}
  ...
  `);
        ...
        let itemdata = [
          {
            ...
            value: "left",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-left iconfont-luckysheet luckysheet-iconfont-wenbenzuoduiqi select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_align.center,
            value: "center",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-center iconfont-luckysheet luckysheet-iconfont-wenbenjuzhongduiqi select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_align.right,
            value: "right",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-align-right iconfont-luckysheet luckysheet-iconfont-wenbenyouduiqi select-none" id="${uuid}"> </div> </div>`,
          },
        ];
        ...
        let itemdata = [
          {
            ...
            value: "top",
            example: `<div class="luckysheet-icon luckysheet-inline-block" select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-valign-top iconfont-luckysheet luckysheet-iconfont-dingbuduiqi select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_align.middle,
            value: "middle",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-valign-middle iconfont-luckysheet luckysheet-iconfont-shuipingduiqi select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_align.bottom,
            value: "bottom",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-valign-bottom iconfont-luckysheet luckysheet-iconfont-dibuduiqi select-none" id="${uuid}"> </div> </div>`,
          },
        ];
        ...
        let itemdata = [
          {
            ...
            value: "overflow",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-overflow iconfont-luckysheet luckysheet-iconfont-yichu1 select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_textWrap.wrap,
            value: "wrap",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-wrap iconfont-luckysheet luckysheet-iconfont-zidonghuanhang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_textWrap.clip,
            value: "clip",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-clip iconfont-luckysheet luckysheet-iconfont-jieduan select-none" id="${uuid}"> </div> </div>`,
          },
        ];
        ...
        let itemdata = [
          {
            ...
            value: "none",
            example: `<div class="luckysheet-icon luckysheet-inline-block" select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont-luckysheet luckysheet-iconfont-wuxuanzhuang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_rotation.angleup,
            value: "angleup",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-angleup iconfont-luckysheet luckysheet-iconfont-xiangshangqingxie select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_rotation.angledown,
            value: "angledown",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-angledown iconfont-luckysheet luckysheet-iconfont-xiangxiaqingxie select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_rotation.vertical,
            value: "vertical",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-vertical iconfont-luckysheet luckysheet-iconfont-shupaiwenzi select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_rotation.rotationUp,
            value: "rotation-up",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-rotation-up iconfont-luckysheet luckysheet-iconfont-wenbenxiangshang select-none" id="${uuid}"> </div> </div>`,
          },
          {
            text: locale_rotation.rotationDown,
            value: "rotation-down",
            example: `<div class="luckysheet-icon luckysheet-inline-block select-none-opacity" id="${uuid}"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-rotation-down iconfont-luckysheet luckysheet-iconfont-xiangxia90 select-none" id="${uuid}"> </div> </div>`,
          },
        ];
    ...
    $("#luckysheet-icon-conditionformat").click(function () {
      ...
      if ($menuButton.length == 0) {
        ...
        &.displayNone{
        width: 126px;padding: 5px;top: 118.5px;left: 1321.48px;display: none;
        }

        &.displayFloatLeft {
        width: 28px; height: 26px;padding: 5px;float: left;
        }

        &.displayTopPositionOne {
        background-position: 0 0;
        }

        &.displayTopPositionTwo {
        background-position: -38px 0;
        }

        &.displayTopPositionThree {
        background-position: -76px 0;
        }

        &.displayTopPositionFour {
        background-position: 0 -36px;
        }

        &.displayTopPositionFive {
        background-position: -38px -36px;
        }

        &.displayTopPositionSix {
        background-position: -76px -36px;
        }

        &.displayTopPositionSeven {
        background-position: 0 -72px;
        }

        &.displayTopPositionEight {
        background-position: -38px -72px;
        }

        &.displayTopPositionNine {
        background-position: -76px -72px;
        }

        &.displayTopPositionTen {
        background-position: 0 -108px;
        }

        &.displayTopPositionEleven {
        background-position: -38px -108px;
        }

        &.displayTopPositionTwelve {
        ...
        &.displayBottomPositionOne {
        background-position: 0 0;
        }

        &.displayBottomPositionTwo {
        background-position: -38px 0;
        }

        &.displayBottomPositionThree {
        background-position: -76px 0;
        }

        &.displayBottomPositionFour {
        background-position: 0 -36px;
        }

        &.displayBottomPositionFive {
        background-position: -38px -36px;
        }

        &.displayBottomPositionSix {
        background-position: -76px -36px;
        }

        &.displayBottomPositionSeven {
        background-position: 0 -72px;
        }

        &.displayBottomPositionEight {
        background-position: -38px -72px;
        }

        &.displayBottomPositionNine {
        background-position: -76px -72px;
        }

        &.displayBottomPositionTen {
        background-position: 0 -108px;
        }

        &.displayBottomPositionEleven {
        background-position: -38px -108px;
        }

        &.displayBottomPositionTwelve {
        background-position: -76px -108px;
        }
      ...
      `);
        //数据条子菜单
        let submenu3 = `<div id="luckysheet-icon-dataBar-menuButton" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-menuButton luckysheet-menuButton-sub luckysheet-mousedown-cancel ${uuidInline} displayNone">
                                    <div itemvalue="0" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionOne" title="${conditionformat_text.gradientDataBar_1}"></div>
                                    </div>
                                    <div itemvalue="1" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionTwo" title="${conditionformat_text.gradientDataBar_2}"></div>
                                    </div>
                                    <div itemvalue="2" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionThree" title="${conditionformat_text.gradientDataBar_3}"></div>
                                    </div>
                                    <div itemvalue="3" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionFour" title="${conditionformat_text.gradientDataBar_4}"></div>
                                    </div>
                                    <div itemvalue="4" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionFive" title="${conditionformat_text.gradientDataBar_5}"></div>
                                    </div>
                                    <div itemvalue="5" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionSix" title="${conditionformat_text.gradientDataBar_6}"></div>
                                    </div>
                                    <div itemvalue="6" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionSeven" title="${conditionformat_text.solidColorDataBar_1}"></div>
                                    </div>
                                    <div itemvalue="7" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionEight" title="${conditionformat_text.solidColorDataBar_2}"></div>
                                    </div>
                                    <div itemvalue="8" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionNine" title="${conditionformat_text.solidColorDataBar_3}"></div>
                                    </div>
                                    <div itemvalue="9" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionTen" title="${conditionformat_text.solidColorDataBar_4}"></div>
                                    </div>
                                    <div itemvalue="10" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionEleven" title="${conditionformat_text.solidColorDataBar_5}"></div>
                                    </div>
                                    <div itemvalue="11" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayTopPositionTwelve" title="${conditionformat_text.solidColorDataBar_6}"></div>
                                    </div>
                                </div>`;

        //色阶
        let submenu4 = `<div id="luckysheet-icon-colorGradation-menuButton" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-menuButton luckysheet-menuButton-sub luckysheet-mousedown-cancel ${uuidInline} displayNone">
                                    <div itemvalue="0" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionOne" title="${conditionformat_text.colorGradation_1}"></div>
                                    </div>
                                    <div itemvalue="1" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionTwo" title="${conditionformat_text.colorGradation_2}"></div>
                                    </div>
                                    <div itemvalue="2" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionThree" title="${conditionformat_text.colorGradation_3}"></div>
                                    </div>
                                    <div itemvalue="3" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionFour"  title="${conditionformat_text.colorGradation_4}"></div>
                                    </div>
                                    <div itemvalue="4" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionFive" title="${conditionformat_text.colorGradation_5}"></div>
                                    </div>
                                    <div itemvalue="5" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionSix" title="${conditionformat_text.colorGradation_6}"></div>
                                    </div>
                                    <div itemvalue="6" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionSeven" title="${conditionformat_text.colorGradation_7}"></div>
                                    </div>
                                    <div itemvalue="7" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionEight" title="${conditionformat_text.colorGradation_8}"></div>
                                    </div>
                                    <div itemvalue="8" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionNine" title="${conditionformat_text.colorGradation_9}"></div>
                                    </div>
                                    <div itemvalue="9" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionTen" title="${conditionformat_text.colorGradation_10}"></div>
                                    </div>
                                    <div itemvalue="10" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionEleven" title="${conditionformat_text.colorGradation_11}"></div>
                                    </div>
                                    <div itemvalue="11" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel ${uuidInline} displayFloatLeft">
                                        <div class="luckysheet-mousedown-cancel bgImgBox ${uuidInline} displayBottomPositionTwelve" title="${conditionformat_text.colorGradation_12}"></div>
                                    </div>
                                </div>`;
          ...
          .on(
            ...
            function () {
              ...
              const uuidInline = getComputedInlineClassStyling(`
                  ...
                  &.displayFloat {
                  float: left;height: 30px;line-height: 30px;margin: 0 5px;
                  }
                  `);
                ...
                switch (itemvalue) {
                  case "greaterThan":
                    ...
                    content = `<div class="box" data-itemvalue="greaterThan">
                                                ...
                                                <div class="${uuidInline} displayMargin">${conditionformat_text.setAs}：</div> 
                                                ${textCellColorHtml} 
                                            </div>`;
                    break;
                  case "lessThan":
                  ...
                  case "betweenness":
                    ...
                    content = `<div class="box" data-itemvalue="betweenness">
                                                ...
                                                <div class="${uuidInline} displayLineHeight">
                                                    <div class="inpbox2 range">
                                                        <input id="conditionVal" class="formulaInputFocus"/>
                                                        <i class="fa fa-table" aria-hidden="true" title="${conditionformat_text.selectCell}"></i>
                                                    </div>
                                                    <div class="${uuidInline} displayFloat">${conditionformat_text.to}</div>
                                                    <div class="inpbox2 range">
                ...
                switch (itemvalue) {
                  case "top10":
                    ...
                    content = `<div class="box" data-itemvalue="top10">
                                                ...
                                                <div class="${uuidInline} displayLineHeight">
                                                    <div class="${uuidInline} displayFloat">${conditionformat_text.top}</div>
                                                    <div class="inpbox2">
                                                        <input id="conditionVal" class="formulaInputFocus" type="number" value="10"/>
                                                    </div>
                                                    <div class="${uuidInline} displayFloat">${conditionformat_text.oneself}</div>
                                                </div>
                                                <div class="${uuidInline} displayMargin">${conditionformat_text.setAs}：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                  ...
                  case "top10%":
                    ...
                    content = `<div class="box" data-itemvalue="top10%">
                                                ...
                                                <div class="${uuidInline} displayLineHeight">
                                                    ...
                                                    <div class="${uuidInline} displayFloat">%</div>
                                                </div>
                                                <div class="${uuidInline} displayMargin">${conditionformat_text.setAs}：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                  ...
                  case "last10":
                    ...
                    content = `<div class="box" data-itemvalue="last10">
                                                ...
                                                <div class="${uuidInline} displayLineHeight">
                                                    <div class="${uuidInline} displayFloat">${conditionformat_text.last}</div>
                                                    <div class="inpbox2">
                                                        <input id="conditionVal" class="formulaInputFocus" type="number" value="10"/>
                                                    </div>
                                                    <div class="${uuidInline} displayFloat">${conditionformat_text.oneself}</div>
                  ...
                  case "last10%":
                    ...
                    content = `<div class="box" data-itemvalue="last10%">
                                                ...
                                                <div class="${uuidInline} displayMargin>设置为：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                    break;
                  case "AboveAverage":
                    ...
                    content = `<div class="box" data-itemvalue="AboveAverage">
                                                ...
                                                <div class="${uuidInline} displayMargin>${conditionformat_text.setAsByArea}：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                    break;
                  case "SubAverage":
      ...
      .on(
        ...
        function (e) {
          ...
          if (e.type === "mouseover") {
            ...
            $attr.attr("id", uuid).addClass("displayPosition").show();
  ...
  getTextSize: function (text, font) {
    ...
    if ($("#luckysheetTextSizeTest").length == 0) {
      $(
        `<span id="luckysheetTextSizeTest" class="displayVisibility ${uuidInline}" >` +
          text +
          "</span>"
      ).appendTo($("body"));
    }
    const uuid = getComputedInlineClassStyling(`
                      &.displayFont {
                      font: ${f},
                      }
  ...
  activeFormulaInput: function (
    ...
    let formulaTxt =
      '<span dir="auto" class="luckysheet-formula-text-color">=</span><span dir="auto" class="luckysheet-formula-text-color">' +
      formula.toUpperCase() +
      `</span><span dir="auto" class="luckysheet-formula-text-color">(</span><span class="luckysheet-formula-functionrange-cell displayColor" rangeindex="0" dir="auto" id="${uuid}">` +
      getRangetxt(
    ...
    const uuidTwo = getComputedInlineStyling(`
                      &.displayPosition {
                      left: ${col_pre}px;
