...
luckysheet.create = function (setting) {
  ...
  luckysheetConfigsetting.cspNonce = $("meta[property='csp-nonce']").attr(
    "content"
  );
  console.log("test", luckysheetConfigsetting.cspNonce);
...
luckysheet.nonce = luckysheetConfigsetting.cspNonce;
//获取所有表格数据
